...
<div id="navbar"> 
  ...
  <span onclick="spanClick('history')" class="current_page">Patient History</span>
	...
	<fieldset id="med_field">
		...
		<div id="med_history">
			...
			<div class="collat_div history_collat">
				...
				<input type="button" onclick="addNewCollatOption(0)" class="pure-button history_button" value="Add History from Collateral">
			</div>
		</div>
	</fieldset>
	<br><br>
			...
			<div class="collat_div history_collat">
				<div id="drug_collat_adds" class="hide_div">
					...
					<div id="drug_collat_row">
						<div class="pure-g-u">
							<div class="pure-u-1-3 select_box" style="max-width:150px">
								<select name="drug_collat_histories">
									<option value="none_selected">--Medicine--</option>
									<option value="statin">Statins</option>
									<option value="antihypertensive">Antihypertensive Medication</option>
									<option value="gastric">Gastric Medication</option>
				...
				<input type="button" onclick="addNewCollatOption(1)" class="pure-button history_button" value="Add History from Collateral">
			</div>
		</div>
	</fieldset>
	<br><br>
	<fieldset id="psych_field">
		...
		<div id="psych_history">
			...
			<div class="collat_div history_collat">
				...
				<input type="button" onclick="addNewCollatOption(2)" class="pure-button history_button" value="Add History from Collateral">
			</div>
		</div>
	</fieldset>
	<br><br>
	<fieldset id="counsel_field">
		...
		<div id="ther_history">
			<div id="ther_adds">
				...
				<div class="collat_div history_collat">
					<input type="button" onclick="showCollatPsych()" class="pure-button history_button" value="Difference from Collateral">
