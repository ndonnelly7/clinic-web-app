...
--
-- Host: 173.194.241.158    Database: elevatordb
-- ------------------------------------------------------
...
CREATE TABLE `Concerns` (
  ...
  `form_FormID` int(11) DEFAULT NULL,
  `most_impactful_concern` varchar(45) DEFAULT NULL,
  `most_impactful_concern_collat` varchar(45) DEFAULT NULL,
...
CREATE TABLE `Lifestyle` (
  ...
  `alcohol_collat_yn` varchar(255) DEFAULT NULL,
  `alcohol_notes` text,
  ...
  `drugs_collat` tinyint(1) NOT NULL,
  `drugs_notes` text,
  ...
  `smoking_collat_yn` varchar(255) DEFAULT NULL,
  `smoking_notes` text,
  ...
  `sleep_difficulty_collat` varchar(255) DEFAULT NULL,
...
CREATE TABLE `LivingSit` (
  ...
  `collat_bills` varchar(255) DEFAULT NULL,
  `collat_cook` varchar(255) DEFAULT NULL,
  `collat_drive` varchar(255) DEFAULT NULL,
  `collat_homelife` varchar(255) DEFAULT NULL,
  `collat_shop` varchar(255) DEFAULT NULL,
  ...
  `collat_driving_other_severity` text,
...
CREATE TABLE `PersonalDetails` (
  ...
  `form_FormID` int(11) DEFAULT NULL,
  `want_reassurance` tinyint(1) NOT NULL DEFAULT '0',
  `want_assessment` tinyint(1) NOT NULL DEFAULT '0',
  `want_information` tinyint(1) NOT NULL DEFAULT '0',
...
-- Dump completed on 2014-09-25 12:19:15
